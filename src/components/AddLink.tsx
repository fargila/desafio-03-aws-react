...
const AddLink: React.FC<AddLinkProps> = ({ onSaveLink }) => 
{
  ...
  return (
    <div className="popupSocial z-30">
      ...
      bg-secondary_text w-2/5 h-full pt-10 pb-6 rounded-2xl">
        ...
        <div className="flex justify-between w-3/4 py-3 mt-3">
          ...
          <button  onClick={saveLink} disabled={!link.trim()} className={`w-1/2 py-3 rounded-md font-bold
